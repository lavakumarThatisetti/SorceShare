    ...
    def _try_authenticate_gssapi(self, future):
        ...
        with self._lock:
            if not self._can_send_recv():
                ...
                # Establish com.sorceshare.userstore.security context and negotiate protection level
                ...
                try:
                    ...
                    while not client_ctx.complete:
                        ...
                        # pass output token to kafka, or send empty response if the com.sorceshare.userstore.security
                        ...
                        # establishes a com.sorceshare.userstore.security context, or it needs further token exchange.
                    ...
                    # Process the com.sorceshare.userstore.security layer negotiation token, sent by the server
                    # once the com.sorceshare.userstore.security context is established.

                    # unwraps message containing supported protection levels and msg size
                    msg = client_ctx.unwrap(received_token).message
                    # Kafka currently doesn't support integrity or confidentiality com.sorceshare.userstore.security layers, so we
